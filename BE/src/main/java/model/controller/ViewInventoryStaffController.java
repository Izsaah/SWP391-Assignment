...
/**
 * Controller for Dealer/Staff to view inventory
 * @author khoac
 */
@WebServlet("/api/staff/viewInventory")
public class ViewInventoryStaffController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            e.printStackTrace();
            ResponseUtils.error(response, "Fail to retrieve inventory: " + e.getMessage());
        }
    }
